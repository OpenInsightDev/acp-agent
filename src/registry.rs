...
/// Supported platform targets for agent binaries.
///
...
impl AgentDistribution {
    /// Returns `true` if the agent references at least one distribution source.
...
pub struct RegistryAgent {
    ...
    /// Published distribution metadata for the agent.
